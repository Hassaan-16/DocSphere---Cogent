...
class Document(models.Model):
    ...
    last_updated_by_user = models.ForeignKey(
        User, on_delete=models.SET_NULL, null=True, related_name="updated_documents"
    )
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
...
class ProjectShare(models.Model):
    ...
    grantee_user = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name="project_shares"
    )
...
class DocumentShare(models.Model):
    ...
    grantee_user = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name="document_shares"
    )
    permission_level = models.CharField(max_length=50, choices=PERMISSION_CHOICES)
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
